...
/*   Updated: 2020/02/26 03:57:53 by melalj           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				t_process *process)
{
	...
	while (cn >= 0)
	{
		...
		global_data->visu_arena[ft_euclidean_mod(cpy_to, MEM_SIZE)].byte =
					store_hexa.buf[cn];
		global_data->visu_arena[ft_euclidean_mod(cpy_to, MEM_SIZE)].color =
